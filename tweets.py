# -*- coding: utf-8 -*-
"""
Created on Sat Sep 14 01:52:19 2019
...
file = open("AndrewYang_Tweets.json", 'w', encoding='utf-8')
file_original = open("AndrewYang_AllTweets.json", 'w', encoding='utf-8')

#make initial request for most recent tweets (200 is the maximum allowed count)
new_tweets = api.user_timeline(screen_name = "AndrewYang",count=200,tweet_mode="extended") ###change screen name
...
for tweet in new_tweets:
    if ("RT @" not in tweet.full_text):
        ...
        if not tweetData["retweeted"] and 'RT @' not in text_en1 :
            ...
            r1={'poi_name':tweetData["user"]["screen_name"]}
            r2={'poi_id':tweetData["user"]["id_str"]}
            r3={"country":"USA"}                                      ######change country
...
#             r8={"reply_text":None}
            ...
            b = {'city': 'New York'}                           ##########change city

            #Tweet Location : NYC
            d = {'tweet_loc': '40.7128, 74.0060'}              ###########change location
...
while len(new_tweets) > 0:
    ...
    new_tweets = api.user_timeline(screen_name = "AndrewYang",count=200,max_id=oldest,tweet_mode="extended") ###change screen name
