...
try:
    ...
    file = open("AndrewYang_replies.json", 'w', encoding='utf-8')
    file_original = open("AndrewYang_replies_original.json", 'w', encoding='utf-8')

    #make initial request for most recent tweets (200 is the maximum allowed count)
    new_tweets = api.search(q = 'to:'+"AndrewYang",count=100, wait_on_rate_limit = True,tweet_mode="extended") ###change screen name
    ...
    for tweet in new_tweets:
        if ("RT @" not in tweet.full_text):
            ...
            if not tweetData["retweeted"] and 'RT @' not in text_en1  :
                ...
                r1={'poi_name':"AndrewYang"}                                 ######changePOI
    ...
    while len(new_tweets) > 0:
        ...
        new_tweets = api.search(q = 'to:'+"AndrewYang",count=100,max_id=oldest, wait_on_rate_limit = True,tweet_mode="extended")###change screen name
